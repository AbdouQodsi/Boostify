                        ...
                        <div className="col-lg-7 mt-lg-0 mt-5">
                            <div className="d-flex gap-4">
                                <div className="position-relative d-inline-block">
                                    <img data-aos="zoom-in" className="rounded-3 position-relative z-1" src="assets/imgs/pages/seo-agency/page-about/img-2.png" alt="Boostify" />
                                </div>
                                <div className="position-relative">
                                    <img data-aos="zoom-in" className="rounded-3 mt-10" src="assets/imgs/pages/seo-agency/page-about/img-3.png" alt="Boostify" />
