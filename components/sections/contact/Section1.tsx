        ...
        <>
                            ...
                            <form action="#" className="input-group mb-3 position-relative wow img-custom-anim-left">
                                <div className="row">
                                    ...
                                    <div className="col-12 mt-5">
                                        ...
                                        <textarea name="message" id="message" cols={30} rows={8} className="py-3 form-control website" placeholder="Enter here" defaultValue={""} />
                                    </div>
                                    <div className="col-12 mt-5">
            ...
            <div className="container-fluid wow img-custom-anim-top">
                <div className="contact-map">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d106376.73625892024!2d-7.669393083557418!3d33.57226019968675!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda7cd4778aa113b%3A0xb06c1d84f310fd3!2sCasablanca!5e0!3m2!1sfr!2sma!4v1769937991732!5m2!1sfr!2sma" width={600} height={450} style={{ border: 0 }} loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
                </div>
            </div>
        </>
    );
