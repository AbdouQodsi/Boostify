                                    ...
                                    <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5" data-aos="fade-up" data-aos-delay={0}>
                                        <div className="founder d-flex justify-content-between border-bottom pb-5">
                                            <div className="d-flex align-items-center">
                                                <Link href="#">
                                                    <img className="rounded-circle icon-shape icon-50" src="assets/imgs/pages/seo-agency/page-home/section-7/avatar-1.png" alt="Boostify" />
                                                </Link>
                                ...
                                <SwiperSlide>
                                    <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5" data-aos="fade-up" data-aos-delay={200}>
                                        <div className="founder d-flex justify-content-between border-bottom pb-5">
                                            <div className="d-flex align-items-center">
                                                <Link href="#">
                                                    <img className="rounded-circle icon-shape icon-50" src="assets/imgs/pages/seo-agency/page-home/section-7/avatar-2.png" alt="Boostify" />
                                                </Link>
                                                <div className="text-start ms-3">
                                                    <Link href="#">
                                ...
                                <SwiperSlide>
                                    <div className="card-testimonial rounded-4 p-5 mb-lg-0 mb-5" data-aos="fade-up" data-aos-delay={400}>
                                        <div className="founder d-flex justify-content-between border-bottom pb-5">
                                            <div className="d-flex align-items-center">
                                                <Link href="#">
                                                    <img className="rounded-circle icon-shape icon-50" src="assets/imgs/pages/seo-agency/page-home/section-7/avatar-3.png" alt="Boostify" />
                                                </Link>
                                                <div className="text-start ms-3">
                                                    <Link href="#">
